...
[![Terraform Format](https://img.shields.io/badge/terraform-fmt-blue?logo=terraform)](https://github.com/PlatformStackPulse/tf-molecule-sqs-queue-dlq-aws/actions)
[![Terraform Validate](https://img.shields.io/badge/terraform-validate-blue?logo=terraform)](https://github.com/PlatformStackPulse/tf-molecule-sqs-queue-dlq-aws/actions)
[![TFLint](https://img.shields.io/badge/tflint-passing-brightgreen?logo=terraform)](https://github.com/PlatformStackPulse/tf-molecule-sqs-queue-dlq-aws/actions)
[![Terraform Test](https://img.shields.io/badge/tests-2%20passed-brightgreen?logo=terraform)](https://github.com/PlatformStackPulse/tf-molecule-sqs-queue-dlq-aws/actions)
[![Security Scan](https://img.shields.io/badge/trivy-passing-brightgreen?logo=aqua)](https://github.com/PlatformStackPulse/tf-molecule-sqs-queue-dlq-aws/actions)
...
[![Documentation](https://img.shields.io/badge/docs-terraform--docs-blue?logo=readthedocs)](https://github.com/PlatformStackPulse/tf-molecule-sqs-queue-dlq-aws/actions)
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_dlq"></a> [dlq](#module\_dlq) | git::https://github.com/PlatformStackPulse/tf-atom-sqs-queue-aws.git | 0fc607b4161d90e581137af1c5f5528d15e36e26 |
| <a name="module_queue"></a> [queue](#module\_queue) | git::https://github.com/PlatformStackPulse/tf-atom-sqs-queue-aws.git | 0fc607b4161d90e581137af1c5f5528d15e36e26 |
| <a name="module_redrive_allow"></a> [redrive\_allow](#module\_redrive\_allow) | git::https://github.com/PlatformStackPulse/tf-atom-sqs-queue-redrive-allow-policy-aws.git | 2c307e9351866f6ac395cc859f522cc1888688b3 |
...
| <a name="input_delay_seconds"></a> [delay\_seconds](#input\_delay\_seconds) | Delay seconds | `number` | `0` | no |
...
| <a name="input_dlq_message_retention_seconds"></a> [dlq\_message\_retention\_seconds](#input\_dlq\_message\_retention\_seconds) | DLQ retention | `number` | `1209600` | no |
...
| <a name="input_max_receive_count"></a> [max\_receive\_count](#input\_max\_receive\_count) | Max receives before DLQ | `number` | `3` | no |
| <a name="input_message_retention_seconds"></a> [message\_retention\_seconds](#input\_message\_retention\_seconds) | Message retention | `number` | `345600` | no |
...
| <a name="input_visibility_timeout_seconds"></a> [visibility\_timeout\_seconds](#input\_visibility\_timeout\_seconds) | Visibility timeout | `number` | `30` | no |

### Outputs

| Name | Description |
|------|-------------|
| <a name="output_dlq_arn"></a> [dlq\_arn](#output\_dlq\_arn) | DLQ ARN |
| <a name="output_dlq_url"></a> [dlq\_url](#output\_dlq\_url) | DLQ URL |
| <a name="output_enabled"></a> [enabled](#output\_enabled) | Whether enabled |
| <a name="output_queue_arn"></a> [queue\_arn](#output\_queue\_arn) | Main queue ARN |
